async function deleteMsisdnClient() {
    ...
    try {
        const response = await fetch(`/provision/v0/delete/msisdn/${msisdn}`, {
            method: 'DELETE',
            headers: {
...
async function deleteEmailClient() {
    ...
    try {
        const response = await fetch(`/provision/v0/delete/email/${email}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${token}`
            }
...
async function deleteDniClient() {
    ...
    try {
        const response = await fetch(`/provision/v0/delete/dni/${dni}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${token}`
            }
