...
//        titular: false,
    ...
    try {
        // const response = await fetch(`http://localhost:8082/provision/v0/updateclient/${msisdn}`, {
           const response = await fetch(`http://172.17.0.1:8100/provision/v0/updateclient/${msisdn}`, {
//            const response = await fetch(`http://provision:8082/provision/v0/updateclient/${msisdn}`, {
            method: 'PUT',
            headers: {
...
//Como la autenticacion la va a centralizar API GW, eliminamos esto. La comunicación interna no va a usar la seguridad.
